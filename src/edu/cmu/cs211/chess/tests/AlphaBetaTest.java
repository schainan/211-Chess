...
/**
 * A few of the initial tests in this class test different depths,
 * and see if that move is chosen.
 * The other tests (pos suite of tests) do the same thing, but all
 * of them are at a depth of 4.
 * There is also a test that checks what move it will make if there is
 * a stalemate or check situation.
 */
public class AlphaBetaTest
{

	@Test(timeout = 1000)
	public void depth2Test1()
	{
